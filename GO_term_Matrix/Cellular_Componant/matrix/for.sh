...
#for i in `ls -r ../selected_level_4_goterm/*gene.tsv ../selected_level_3_goterm/*gene.tsv`
#do
#echo $i 
#./script.sh $i
#done
...
#mv ../selected_level_4_goterm/*tiff $path
#mv ../selected_level_4_goterm/*final.tsv $path
#mv ../selected_level_4_goterm/*gene_count.tsv $path2
